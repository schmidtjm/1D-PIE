...
#####################################################
        ...
        if body == 'Mercury':
            ...
            self.epsm = 1.144
            self.epsc = 1.093
            self.Pcrossover = 30e+9   # set to very high value, maybe beneath this (be careful with magma formation in the lower mantle)
            self.dIW = 4 
            self.km = 4.375 
            self.kcr = 3.0          
            self.kc = 50            
            ...
            self.epsm = 1.92
            self.epsc = 1.099
            self.Pcrossover = 50e+9   # set to very high value, maybe beneath this (be careful with magma formation in the lower mantle)
            self.dIW = 4 
            self.km = 4.966        
            self.kcr = 3.0           
            self.kc = 50             
            ...
            self.epsm = 1.746
            self.epsc = 1.110
            self.Pcrossover = 50e+9  # set highest so it does not interfere with melting  
            self.dIW = 4 
            self.km = 8.298           
            self.kcr = 3.0             
            self.kc = 50               
